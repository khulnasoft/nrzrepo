...
pub enum CacheError {
    ...
    ApiClientError(Box<nrzrepo_api_client::Error>, #[backtrace] Backtrace),
    ...
    PathError(#[from] nrzpath::PathError, #[backtrace] Backtrace),
...
impl From<nrzrepo_api_client::Error> for CacheError {
    fn from(value: nrzrepo_api_client::Error) -> Self {
