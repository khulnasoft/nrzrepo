...
/// Base URL for links supplied in error messages. You can use the NRZ_SITE
/// environment variable at compile time to set a base URL for easier debugging.
///
/// When NRZ_SITE is not provided at compile time, the production site will be
/// used.
pub const NRZ_SITE: &str = match option_env!("NRZ_SITE") {
    Some(url) => url,
