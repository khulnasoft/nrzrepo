...
mod tests {
    ...
    use nrzrepo_lockfiles::Lockfile;
    use nrzrepo_repository::{package_graph::PackageInfo, package_manager::PackageManager};
    use nrzrepo_scm::SCM;
    ...
    /// nrz does not consider changes to folders when evaluating hashes,
    /// only to files
    #[test]
