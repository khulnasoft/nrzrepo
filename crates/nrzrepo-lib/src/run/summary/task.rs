...
impl From<nrzrepo_cache::CacheSource> for CacheSource {
    fn from(value: nrzrepo_cache::CacheSource) -> Self {
        match value {
            nrzrepo_cache::CacheSource::Local => Self::Local,
            nrzrepo_cache::CacheSource::Remote => Self::Remote,
        }
    }
}
...
impl TaskEnvVarSummary {
    pub fn new(
        ...
        let pass_through = task_definition
            .pass_through_env
            .as_deref()
            .map(|pass_through_env| -> Result<_, nrzrepo_env::Error> {
