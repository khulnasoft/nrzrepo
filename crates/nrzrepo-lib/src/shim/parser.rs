...
// example)
static NRZ_PURE_OUTPUT_ARGS: [&str; 6] = [
    "--json",
    "--dry",
    "--dry-run",
    "--dry=json",
...
pub struct ShimArgs {
    ...
    pub remaining_nrz_args: Vec<String>,
...
impl ShimArgs {
    ...
    fn parse_from_iter(
        ...
        let mut remaining_nrz_args = Vec::new();
    ...
    fn has_json_flags(&self) -> bool {
        self.remaining_nrz_args
            .iter()
            .any(|arg| NRZ_PURE_OUTPUT_ARGS.contains(&arg.as_str()))
    }
    ...
    fn has_notifier_skip_flags(&self) -> bool {
        self.remaining_nrz_args
            .iter()
            .any(|arg| NRZ_SKIP_NOTIFIER_ARGS.contains(&arg.as_str()))
    }
...
mod test {
    ...
    struct ExpectedArgs {
        ...
        pub verbosity: usize,
        pub force_update_check: bool,
        pub remaining_nrz_args: &'static [&'static str],
    ...
    impl ExpectedArgs {
        fn build(self, invocation_dir: &AbsoluteSystemPath) -> ShimArgs {
            ...
            ShimArgs {
                ...
                remaining_nrz_args: remaining_nrz_args
                    .iter()
    ...
    #[test_case(
        ...
        ExpectedArgs {
            verbosity: 3,
            remaining_nrz_args: &["--verbosity", "3"],
            ..Default::default()
        }
        ; "verbosity flag 3"
    )]
    ...
    #[test_case(
        ...
        ExpectedArgs {
            verbosity: 2,
            remaining_nrz_args: &["--verbosity=3", "-vv"],
            ..Default::default()
        }
        ; "multi verbosity"
    )]
    ...
    #[test_case(
        &["nrz", "--check-for-update=true"],
        ExpectedArgs {
            force_update_check: false,
            remaining_nrz_args: &["--check-for-update=true"],
            ..Default::default()
        }
