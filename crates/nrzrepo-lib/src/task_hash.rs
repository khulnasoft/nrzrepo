...
use nrzrepo_repository::package_graph::{PackageInfo, PackageName};
use nrzrepo_scm::SCM;
                            ...
                            match result {
                                Ok(hashes_resp) => Some(
                                    hashes_resp
                                        ...
                                        .map(|(path, hash)| {
                                            (
                                                nrzpath::RelativeUnixPathBuf::new(path)
...
pub fn get_external_deps_hash(
    transitive_dependencies: &Option<HashSet<nrzrepo_lockfiles::Package>>,
) -> String {
