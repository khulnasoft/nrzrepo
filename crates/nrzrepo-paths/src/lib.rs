...
//! Nrzrepo's path handling library.
//! Defines distinct path types for the different uses of paths in Nrzrepo's
//! codebase.
//!
...
//! recommended is inside nrzpath itself. But that unchecked initialization
