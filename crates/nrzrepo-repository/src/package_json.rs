...
mod test {
    ...
    #[test_case(json!({"dependencies": { "nrz": "latest" }, "foo": "bar"}) ; "dependencies")]
    #[test_case(json!({"devDependencies": { "nrz": "latest" }, "foo": "bar"}) ; "dev dependencies")]
    #[test_case(json!({"optionalDependencies": { "nrz": "latest" }, "foo": "bar"}) ; "optional dependencies")]
    #[test_case(json!({"peerDependencies": { "nrz": "latest" }, "foo": "bar"}) ; "peer dependencies")]
    #[test_case(json!({"scripts": { "build": "nrz build" }, "foo": "bar"}) ; "scripts")]
    #[test_case(json!({"resolutions": { "nrz": "latest" }, "foo": "bar"}) ; "resolutions")]
