use nrzpath::{AbsoluteSystemPath, AnchoredSystemPathBuf, RelativeUnixPathBuf};
use tracing::Span;
...
#[cfg(test)]
mod test {
    use nrzpath::{AbsoluteSystemPathBuf, RelativeUnixPathBuf, RelativeUnixPathBufTestExt};
    ...
    fn test_read_object_hashes() {
        ...
        let fixture_path =
            git_root.join_components(&["crates", "nrzrepo-scm", "fixtures", "01-git-hash-object"]);
