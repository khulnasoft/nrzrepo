...
mod test {
    ...
    #[test_case("\ra whole message \n", "nrz > \rnrz > a whole message \n" ; "basic prefix cr")]
    #[test_case("no return", "nrz > no return" ; "no return")]
    #[test_case("foo\rbar\rbaz", "nrz > foo\rnrz > bar\rnrz > baz" ; "multiple crs")]
    #[test_case("foo\r", "nrz > foo\r" ; "trailing cr")]
