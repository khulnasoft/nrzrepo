---
title: Dev Server
description: Learn more about the Nrzpack Dev Server.
---

Nrzpack is optimized to give you an extremely fast development server. We considered these features indispensable.
...
Nrzpack supports Hot Module Replacement out of the box. Because of our [incremental architecture](/pack/docs/incremental-computation), we are hyper-optimized for delivering fast updates.
...
Nrzpack supports Fast Refresh out of the box for React. Support for other frameworks will be [added over time](/pack/docs/features/frameworks).
