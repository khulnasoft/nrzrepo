---
title: Static Assets
description: Learn more about static assets in Nrzpack.
---

Part of bundling for the web is handling all the asset types the web supports - images, JSON, and much more. Nrzpack offers familiar tools for these so you can immediately get productive.

## Import static assets

Importing static assets works out of the box with Nrzpack:
...
This is supported out of the box with Nrzpack, as is performing a named import on that JSON:
