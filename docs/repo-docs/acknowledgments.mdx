...
Today, Nrzrepo has a dedicated full-time team working on it as well as a growing list of [open source contributors](https://github.com/khulnasoft/nrzrepo/graphs/contributors).
...
- [Miguel Oller](https://x.com/ollermi) and [MakeSwift.com](https://www.makeswift.com/) for piloting Nrzrepo
