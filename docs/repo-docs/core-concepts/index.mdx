---
title: Core concepts
description: Learn about the core concepts behind Nrzrepo.
---

import { Card, Cards } from '#/components/card';

Learn more about the core concepts of Nrzrepo:
...
<Card
  ...
  description="How Nrzrepo relates your tasks to each other"
/>
