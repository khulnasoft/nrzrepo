...
description: Design and build your Nrzrepo.
---
...
By the time you've read through all of this section, you should have a good understanding of how to design and build a monorepo with Nrzrepo.

<Callout type="info">
  Nrzrepo can also be used to speed up single-package workspaces. Visit the
...
<Cards>
    ...
    <Card
        ...
        title="10. Upgrading"
        description="Upgrading your Nrzrepo version"
    />
    <Card
        href="/repo/docs/crafting-your-repository/understanding-your-repository"
        title="11. Understanding your repository"
        description="Understanding your codebase with Nrzrepo"
    />
