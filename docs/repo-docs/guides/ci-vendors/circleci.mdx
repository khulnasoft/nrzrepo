---
title: CircleCI
description: Learn how to use CircleCI with Nrzrepo.
---

import { PackageManagerTabs, Tab } from '#/components/tabs';
import { Callout } from '#/components/callout';

The following example shows how to use Nrzrepo with [CircleCI](https://circleci.com/).
...
<Callout type="warn" title="TTY on CircleCI">
  ...
  that crash Nrzrepo's terminal UI. To workaround this, set the
