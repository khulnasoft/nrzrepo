...
To get started with Nuxt in a Nrzrepo quickly, use [the `with-vue-nuxt` example](https://github.com/khulnasoft/nrzrepo/tree/main/examples/with-vue-nuxt):
...
```bash title="Terminal"
yarn dlx create-nrz@latest -e with-vue-nuxt
```
...
```bash title="Terminal"
pnpm dlx create-nrz@latest -e with-vue-nuxt
```
