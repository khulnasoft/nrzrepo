---
title: Prisma
description: Learn how to use Prisma in a Nrzrepo.
---
...
[Their official guide](https://www.prisma.io/docs/guides/using-prisma-orm-with-nrzrepo#1-create-your-monorepo-using-nrzrepo) describes how to integrate Prisma into a Nrzrepo, including:
