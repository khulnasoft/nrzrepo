---
title: shadcn/ui
description: Learn how to use shadcn/ui in a Nrzrepo.
---
...
To learn more about using shadcn/ui in Nrzrepo, [visit the docs for shadcn/ui](https://ui.shadcn.com/docs/monorepo).
