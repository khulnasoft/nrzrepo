...
description: Learn about the file glob specification used by `nrz`.
---

File globs are used throughout Nrzrepo for configuring which files to include or exclude in various contexts, allowing you to specifically define the files you want `nrz` to use.
