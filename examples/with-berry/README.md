# Nrzrepo starter with berry (yarn v2+)
...
```sh
npx create-nrz@latest -e with-berry
```

## What's inside?

This Nrzrepo uses [yarn v2+ (berry)](https://yarnpkg.com/) as a packages manager. It includes the following packages/apps:
