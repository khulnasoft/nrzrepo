...
const LINKS = [
  {
    ...
    description: "Find in-depth information about Nrzrepo features and API.",
  },
  {
    title: "Learn",
  ...
  },
  {
    ...
    description:
      "Instantly deploy your Nrzrepo to a shareable URL with Vercel.",
  },
];
...
<template>
  <main class="main">
    <div class="description">
      ...
      <div>
        <a
          href="https://vercel.com?utm_source=create-nrz&utm_medium=basic&utm_campaign=create-nrz"
        ...
        <div class="logos">
          ...
          <div class="logo">
            <img
              ...
              height="120"
              priority
              src="./assets/nrzrepo.svg"
              width="120"
            />
          </div>
        </div>
        <Gradient class="backgroundGradient" conic />
        <div class="nrzrepoWordmarkContainer">
          <svg
            class="nrzrepoWordmark"
            viewBox="0 0 506 50"
            width="200"
            xmlns="http://www.w3.org/2000/svg"
          >
            <title>Nrzrepo logo</title>
            <path
