  ...
  invalid: [
    {
      ...
      ...options(),
      errors: [{ message: "X is not listed as a dependency in nrz.json" }],
    },
    {
      code: "const { X, Y, Z } = import.meta.env;",
      ...options(),
      errors: [
        { message: "X is not listed as a dependency in nrz.json" },
        { message: "Y is not listed as a dependency in nrz.json" },
        { message: "Z is not listed as a dependency in nrz.json" },
      ],
    },
    {
    ...
    },
    {
      ...
      errors: [
        {
          message: "NOT_THERE is not listed as a dependency in nrz.json",
        },
      ],
    },
    {
      ...
      errors: [{ message: "KEY is not listed as a dependency in nrz.json" }],
    },
    {
      code: `
      ...
      errors: [
        {
          message:
            "TASK_ENV_KEY_NEW is not listed as a dependency in nrz.json",
        },
        {
          message:
            "GLOBAL_ENV_KEY_NEW is not listed as a dependency in nrz.json",
        },
        {
          message: "ENV_VAR_ONE is not listed as a dependency in nrz.json",
        },
        {
          message: "ENV_VAR_TWO is not listed as a dependency in nrz.json",
        },
      ],
    },
    {
      ...
      errors: [
        ...
        {
          message:
            "ENV_VAR_NOT_ALLOWED is not listed as a dependency in nrz.json",
        },
      ],
    },
    {
