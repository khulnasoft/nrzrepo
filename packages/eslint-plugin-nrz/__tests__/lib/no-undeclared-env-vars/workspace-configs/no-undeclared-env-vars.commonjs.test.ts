  ...
  invalid: [
    {
      ...
      errors: [
        {
          message:
            "ENV_3 is not listed as a dependency in the root nrz.json or workspace (apps/web) nrz.json",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "ENV_2 is not listed as a dependency in the root nrz.json or workspace (apps/docs) nrz.json",
        },
      ],
    },
    {
      ...
      errors: [
        {
          message:
            "NEXT_PUBLIC_EXCLUDE is not listed as a dependency in the root nrz.json or workspace (apps/web) nrz.json",
        },
        {
          message:
            "NEXT_PUBLIC_EXCLUDED is not listed as a dependency in the root nrz.json or workspace (apps/web) nrz.json",
        },
      ],
    },
  ],
