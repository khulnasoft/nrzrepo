...
codemodCli
  .name("@nrz/codemod")
  .description(
    "Codemod transformations to help upgrade your Nrzrepo codebase when a feature is deprecated."
  )
...
codemodCli
  ...
  .description("Migrate a project to the latest version of Nrzrepo")
  ...
  .option("--install", "Install new version of nrz after migration", true)
  .option(
    "--force",
