...
const nrzGenCli = new Command();

nrzGenCli
  .name(picocolors.bold(logger.nrzGradient("@nrz/gen")))
  .description("Extend your Nrzrepo")
...
nrzGenCli
  ...
  .addOption(
    new Option(
      "-c, --config <config>",
      "Generator configuration file (default: nrz/generators/config.js"
    )
  )
  .addOption(
    new Option(
