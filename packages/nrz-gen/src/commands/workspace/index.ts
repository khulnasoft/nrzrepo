...
export interface NrzGeneratorCLIOptions {
  name?: string;
  // default to true
  empty: boolean;
  copy?: string | boolean;
...
function parse(opts: NrzGeneratorCLIOptions): NrzGeneratorOptions {
 ...
 */
export async function workspace(opts: NrzGeneratorCLIOptions) {
