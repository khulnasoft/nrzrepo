...
import { logger, type PackageJson, type DependencyGroups } from "@nrz/utils";
import { gatherAddRequirements } from "../utils/gatherAddRequirements";
import type { NrzGeneratorArguments } from "./types";

export async function generate({ project, opts }: NrzGeneratorArguments) {
