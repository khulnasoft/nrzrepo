...
// TODO: find-up to nrz-repository? This currently only works from nrz-repository/js/dist
const localPath = join(__dirname, "..", "..", "native", "@nrz");
const pkgRoot = "@nrz/repository";
