...
describe("TelemetryConfig", () => {
  ...
  afterEach(() => {
    ...
    delete process.env.NRZ_TELEMETRY_DISABLED;
    delete process.env.NRZ_TELEMETRY_MESSAGE_DISABLED;
    delete process.env.NRZ_TELEMETRY_DEBUG;
  });
  ...
  describe("isEnabled", () => {
    const testCases = [
      ...
      { envVar: "NRZ_TELEMETRY_DISABLED", value: "1", expectedResult: false },
      {
        envVar: "NRZ_TELEMETRY_DISABLED",
        value: "true",
  ...
  describe("isTelemetryWarningEnabled", () => {
    it("should return false if NRZ_TELEMETRY_MESSAGE_DISABLED is set to '1'", () => {
      process.env.NRZ_TELEMETRY_MESSAGE_DISABLED = "1";
    ...
    it("should return false if NRZ_TELEMETRY_MESSAGE_DISABLED is set to 'true'", () => {
      process.env.NRZ_TELEMETRY_MESSAGE_DISABLED = "true";
    ...
    it("should return true if NRZ_TELEMETRY_MESSAGE_DISABLED is not set", () => {
      const result = telemetryConfig.isTelemetryWarningEnabled();
  ...
  describe("isDebug", () => {
    it("should return true if NRZ_TELEMETRY_DEBUG is set to '1'", () => {
      process.env.NRZ_TELEMETRY_DEBUG = "1";
    ...
    it("should return true if NRZ_TELEMETRY_DEBUG is set to 'true'", () => {
      process.env.NRZ_TELEMETRY_DEBUG = "true";
    ...
    it("should return false if NRZ_TELEMETRY_DEBUG is not set", () => {
      const result = TelemetryConfig.isDebug();
